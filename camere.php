...
$sql = "INSERT INTO REZERVARE (tipRezervare, dataSosire, dataPlecare, nume, prenume, adresa, telefon, email) values('$tip', '$arrDate', '$depDate', '$nume', '$prenume', '$adresa', '$tel', '$email')";
$sql2 = "SELECT COUNT(idRezervare) FROM `REZERVARE` WHERE tipRezervare = '$tip' AND ((dataSosire >= '$arrDate' AND dataSosire < '$depDate') OR (dataPlecare > '$arrDate' AND dataPlecare <= '$depDate'))";
...
{
  echo '<center>'."Data plecării este invalidă!".'</center>';
}
